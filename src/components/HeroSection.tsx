      ...
      >
        ...
        >
          ...
          <div className='flex flex-col sm:flex-row w-full mt-5 mb-auto justify-center px-3 md:px-0'>
            <ButtonType
              buttonClass='px-8 h-8 sm:w-1/2 sm:mr-2 md:ml-0 font-proxiSemiBold text-kmcOrange border-kmcOrange hover:bg-kmcOrange hover:text-white hover:border-kmcOrange'
              text='Read More'
              buttonType='default'
            />
            
            <ButtonType
              buttonClass='px-8 h-8 sm:w-1/2 sm:mr-2 md:ml-0 font-proxiSemiBold text-white border-kmcOrange'
              text='Book Now'
              buttonType='primary'
            />
          </div>
